...
class BuildBidzAPITester:
    ...
    def test_bid_file_download_functionality(self):
        ...
        buyer_data = {
            ...
            "role": "buyer",
            "gst_number": "27ABCDE1234F1Z5",
            "address": "123 Bid File Test Street, Mumbai, Maharashtra - 400001"
        }
        ...
        if hasattr(self, 'salesman1_token') and self.salesman1_token:
            salesman_bid_data = {
                ...
                "company_gst_number": "27PQRST5678U9Z1",
    ...
    def test_chat_initialization_fix(self):
        ...
        if hasattr(self, 'buyer_token') and self.buyer_token:
            success, unauthorized_messages = self.run_test(
                "Unauthorized User Access Chat (Should Fail)",
                "GET",
                f"jobs/{chat_job_id}/chat",
                403,
                token=self.buyer_token
            ...
            if success:
                print(f"   ✅ Unauthorized users properly blocked from chat access")
            else:
                print(f"   ❌ Unauthorized access control failed")
